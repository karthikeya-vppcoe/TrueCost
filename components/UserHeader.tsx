...
const UserHeader: React.FC<UserHeaderProps> = ({ user, onLogout, theme, setTheme, onNavigateProfile }) => {
  return (
    <header className="sticky top-0 z-10 bg-white dark:bg-gray-800 flex-shrink-0 border-b border-gray-200 dark:border-gray-700">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
                <div className="flex items-center space-x-3">
                    ...
                    <h1 className="text-xl font-bold text-gray-900 dark:text-white tracking-wide">TrueCost</h1>
                </div>
