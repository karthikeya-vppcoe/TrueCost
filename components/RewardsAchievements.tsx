...
const RewardsAchievements: React.FC<RewardsAchievementsProps> = ({ totalSavings, checkoutCount }) => {
    ...
    const achievements: Achievement[] = [
        ...
        },
        {
            ...
            progress: Math.min(totalSavings, 10000),
            target: 10000,
            reward: '50 points'
        },
        {
        ...
        },
        {
            ...
            icon: '👑',
            unlocked: totalSavings >= 25000,
            progress: Math.min(totalSavings, 25000),
            target: 25000,
            reward: '100 points'
        },
        {
            id: '6',
            title: 'Elite Saver',
            description: 'Save ₹50,000 in total',
            icon: '💎',
            unlocked: totalSavings >= 50000,
            progress: Math.min(totalSavings, 50000),
            target: 50000,
            reward: '200 points'
        }
    ];
